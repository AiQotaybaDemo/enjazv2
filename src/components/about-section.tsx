      ...
      <div className="container md:max-w-7xl mx-auto">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-8">
            <div>
              <div className="mb-4 inline-block rounded-lg bg-[#14697d]/10 px-4 py-2">
                <h4 className="text-lg font-semibold text-[#14697d]">
                  {t("title")}
                </h4>
              </div>
            ...
            <ul className="space-y-4">
              {[ t("features.0"), t("features.1"), t("features.2"), t("features.3")].map((feature: any, index: any) => (
                <li key={index} className="flex items-center gap-3">
                  <div className="rounded-full bg-[#14697d]/10 p-2">
                    <CheckCircle className="h-5 w-5 text-[#14697d]" />
                  </div>
