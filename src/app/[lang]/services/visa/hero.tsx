...
export async function VisaHero({ dict, lang }: any) {
  const t = await getTranslations("services.visa.hero")
          ...
          <ConsultationDialog
            ...
            trigger={
              <Button
                asChild
                size="lg"
                className="bg-gradient-to-r text-white cursor-pointer   from-[#1289A6] to-[#1a8ba7] px-8 py-6 text-lg font-semibold shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl"
              >
                <p> {t("cta")} </p>
              </Button>
            }
