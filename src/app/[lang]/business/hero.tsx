...
export function BusinessHero() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-gray-50 to-white py-24">
      <div className={`container mx-auto ${isRTL ? "rtl" : ""}`} dir={isRTL ? "rtl" : "ltr"}>
        <div className="mx-auto max-w-4xl text-center">
          ...
          <ConsultationDialog
            trigger={
              <Button
                size="lg"
                className="bg-[#1289A6] text-white cursor-pointer px-8 py-6 text-lg font-semibold shadow-lg transition-all hover:-translate-y-0.5 hover:bg-[#1289A6]/90 hover:shadow-xl"
              >
                {heroContent.cta}
              </Button>
            }
