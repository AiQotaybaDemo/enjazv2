          ...
          <ConsultationDialog
            trigger={
              <Button
                asChild
                size="lg"
                className=" text-white cursor-pointer bg-gradient-to-r from-[#14697d] to-[#1a8ba7] px-8 py-6 text-lg font-semibold shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl"
              >
                <p>{t("cta")}</p>
              </Button>
            }
